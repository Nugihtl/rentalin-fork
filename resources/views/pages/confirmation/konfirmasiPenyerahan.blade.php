    ...
    <div class="bg-white rounded-[12px] w-full max-w-[320px] px-[24px] py-[28px] text-center">
        ...
        <div class="grid grid-cols-2 gap-[10px]">
            <button type="button"
                    ...
                    class="h-[36px] rounded-[6px] border border-[#34699A] text-[#34699A] focus:outline-none focus:ring-2 focus:ring-[#7BAFE3] focus:ring-offset-2 transition text-[12px] font-semibold">
                Batal
            </button>
