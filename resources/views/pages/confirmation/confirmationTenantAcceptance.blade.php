...
<head>
    ...
    <title>Konfirmasi Penerimaan Penyewa - P2P Rental</title>
...
<!-- ================= CONTENT ================= -->
<main class="w-<main class="w-full max-w-[435px] sm:max-w-[940px] lg:max-w-[1220px] mx-auto px-[20px] sm:px-[44px] lg:px-[66px] pt-[22px] sm:pt-[38px] pb-[48px] lg:pb-[70px]"> max-w-[435px] sm:max-w-[940px] lg:max-w-[1220px] mx-auto px-[20px] sm:px-[44px] lg:px-[66px] pt-[22px] sm:pt-[38px] pb-[48px] lg:pb-[70px]">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-[360px_1fr] lg:grid-cols-[410px_1fr] gap-[28px] items-start">
        ...
        <section class="bg-white border border-[#E5EAF0] rounded-[8px] px-[14px] sm:px-[22px] py-[20px] sm:py-[22px] shadow-[0px_2px_6px_rgba(0,0,0,0.10)]">
            ...
            <div class="flex items-center gap-[14px] sm:gap-[18px] mb-[22px]">
                ...
                <img
                    src="{{ asset('assets/products/tank-m103.png') }}"
                    alt="Tank M103"
        ...
        <section class="bg-white border border-[#E5EAF0] rounded-[8px] px-[14px] sm:px-[26px] py-[22px] shadow-[0px_2px_6px_rgba(0,0,0,0.10)]">
            ...
            <div class="border-t border-[#C3DAFE] mt-[24px] pt-[22px]">
                ...
                <p class="text-[13px] mt-[6px] mb-[14px] leading-[20px]">
                    Checklist sesuai dengan kondisi barang saat diterima.
                </p>
                ...
                <div class="space-y-[10px] text-[14px]">
                    ...
                    <label class="flex items-center gap-[10px]">
                        ...
                        Body tank dalam kondisi baik
                    </label>

                    <label class="flex items-center gap-[10px]">
                        <input type="checkbox" class="w-[16px] h-[16px] accent-[#34699A]">
                        Roda/rantai tank lengkap
                    </label>

                    <label class="flex items-center gap-[10px]">
                        <input type="checkbox" class="w-[16px] h-[16px] accent-[#34699A]">
                        Meriam utama dalam kondisi baik
                    </label>
                    ...
                    <label class="flex items-center gap-[10px]">
                        <input type="checkbox" class="w-[16px] h-[16px] accent-[#34699A]">
                        Dokumen/kelengkapan sewa tersedia
                    </label>
            ...
            <!-- CATATAN -->
            <div class="border-t border-[#C3DAFE] mt-[24px] pt-[22px]">
                <h2 class="text-[18px] font-bold mb-[12px]">
                    Catatan (Opsional)
                </h2>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-[12px] mt-[24px]">
                ...
                <button class="w-full sm:w-auto h-[44px] px-[28px] rounded-[8px] border border-[#34699A] bg-white text-[#34699A] text-[15px] font-semibold">
                    Batal
                </button>
