...
<main class="w-full max-w-[1220px] mx-auto px-[16px] sm:px-[28px] md:px-[44px] lg:px-[66px] pt-[22px] sm:pt-[38px] pb-[48px] lg:pb-[70px]">
    ...
    <form id="mainConfirmForm"
              action="{{ route('transaksi.simpanKonfirmasiPenerimaan', $rental->id) }}"
              method="POST"
            ...
            <div class="mb-[22px]">
                ...
                <p class="text-[14px] text-[#5F6B7A] leading-[24px] mb-[18px]">
                    Upload minimal 3 foto yang memperlihatkan kondisi barang saat diterima.
                </p>
            ...
            <div class="mb-[22px]">
                ...
                <p class="text-[14px] text-[#696969] leading-[20px] mb-[12px]">
                    ...
                    Jika ada yang tidak diterima, pilih kondisi “Tidak Lengkap” dan transaksi langsung dialihkan ke proses pengembalian.
                </p>
            ...
            <div class="bg-[#EAF3FF] text-[#34699A] rounded-[8px] px-[14px] py-[12px] flex items-start gap-[10px] mb-[22px]">
                ...
                <p class="text-[12px] font-semibold leading-[20px]">
                    Setelah konfirmasi berhasil, status transaksi akan berubah menjadi “Disewa”.
                </p>
            </div>
    ...
    <div id="successModal"
        ...
        <div class="bg-white border border-[#BFD8F4] rounded-[12px] w-full max-w-[320px] px-[24px] py-[28px] text-center shadow-[0px_8px_24px_rgba(0,0,0,0.18)]">
            ...
            <h3 class="text-[15px] font-bold text-[#34699A] mb-[8px]">
                {{ session('success_title', 'Konfirmasi Penerimaan Berhasil') }}
            </h3>

            <p class="text-[12px] text-[#696969] leading-[20px] mb-[22px]">
                {{ session('success_message', session('success', 'Data penerimaan barang berhasil disimpan.')) }}
            </p>
...
<div id="confirmModal"
    ...
    <div class="bg-white border border-[#BFD8F4] rounded-[12px] w-full max-w-[320px] px-[24px] py-[28px] text-center shadow-[0px_8px_24px_rgba(0,0,0,0.18)]">
        ...
        <h3 class="text-[15px] font-bold text-[#34699A] mb-[8px]">
            Yakin konfirmasi penerimaan?
        </h3>

        <p class="text-[12px] text-[#696969] leading-[20px] mb-[22px]">
            Pastikan barang sudah diterima dan data yang diunggah sudah benar.
        </p>

        <div class="grid grid-cols-2 gap-[10px]">
            <button type="button"
                    onclick="closeConfirmModal()"
                    class="h-[36px] rounded-[6px] border border-[#34699A] text-[#34699A]  hover:bg-[#EAF3FF] focus:outline-none focus:ring-2 focus:ring-[#7BAFE3] focus:ring-offset-2 transition text-[13px] font-semibold">
                Batal
            </button>

            <button type="button"
                    onclick="submitMainForm()"
                    class="h-[36px] rounded-[6px] bg-[#34699A] text-white hover:bg-[#28527A] focus:outline-none focus:ring-2 focus:ring-[#7BAFE3] focus:ring-offset-2 transition text-[13px]  font-semibold">
                Ya, Konfirmasi
            </button>
        </div>
    </div>
